...
import { roomsStandard } from "../../../data";
import RoomsStandardGallery from "./RoomsStandardGallery";

const RoomsStandard: React.FC = () => {
  return (
    <StyledYurt className="yurt">
      <div className="yurt-grid">
        <RoomsStandardGallery />
        {roomsStandard.map((room, index) => (
